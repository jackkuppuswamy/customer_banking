"""
This module defines a function to create a Savings account, calculate interest earned, and update the account balance.

Functions:
    create_savings_account(balance, interest_rate, months):
        Creates a savings account instance with the given initial balance and interest rate.
        ...
        Args:
            ...
            months (int): The length of time in months for the savings.
...
def create_savings_account(balance, interest_rate, months):
    ...
    SavingsAccount = Account.Account(balance, interest_rate )
